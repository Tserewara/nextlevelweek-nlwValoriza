...
class CreateComplimentService {
    execute({ tag_id, user_sender, user_receiver, message, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userReceiverExists = yield usersRepositories.findOne(user_receiver);
            ...
            yield complimentsRepositories.save(compliment);
            return compliment;
        });
    }
}
